...
def test_booking(listings_collection_one_room):
    """
...
def test_booking_when_a_day_is_not_available(listings_collection_one_room):
    """
    Test if function works with one room in the database
    """
    sample_room = listings_collection_one_room.find()[0]
...
def test_booking_when_room_id_is_wrong(listings_collection_one_room):
    """
    Test if function works with one room in the database
    """
    event = {
